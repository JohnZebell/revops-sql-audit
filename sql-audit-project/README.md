...
*Learning project. The data is generated, the pipeline it models is real — the deal-audit tool that writes to `audit_runs` is a working n8n + Airtable + Postgres build. Full case study at [johnzebellportfolio.vercel.app](https://johnzebellportfolio.vercel.app).*
